...
var vitesseLutins=10;
    ...
    var s3=new sound("footsteps_snow_4.mp3");
...
var tempsAttrapez=0;
var s4= new sound("Emotisound-hoho.wav");
var s5= new sound("Ho Ho Ho St Nick-SoundBible.com-1954250969.mp3");
    function draw() {
    ...
    var s2=new sound("sf-laugh-elf-creature-01.mp3");
...
function atrapeBoule1() {
    if(santa.dxSanta > Vxboule1-40 && santa.dxSanta < Vxboule1+40 && santa.dySanta > Vyboule1-47 && santa.dySanta < Vyboule1+47)
    {
		...
		if(collisionLutin(listeDeLutins[i])== true){
			argent +=5;
		}	
    }
...
//barre de chargement pour la boule de noel // taille de lutin => valeur collision a changer // traineau esthetique a la fin //
